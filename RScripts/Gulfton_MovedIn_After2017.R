...
View(ACS_BR_2021_MovedIn_After2017)

ACS_Gulf_2021_MovedIn_After2017 = subset(ACS_BR_2021_MovedIn_After2017, Neighborhood.x == 'Gulfton/Sharpstown')

View(ACS_Gulf_2021_MovedIn_After2017)

st_geometry(ACS_Gulf_2021_MovedIn_After2017) = "geometry"

mapview(ACS_Gulf_2021_MovedIn_After2017, zcol = "Percent_Of_Population")